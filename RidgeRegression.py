...
print("Starting Ridge Regression script...")
...
param_grid = {"alpha": [1, 5, 10, 15, 20, 25]}

print("Tuning Ridge Regression (searching for best alpha)...")
...
print("\n" + "=" * 80)
print("submission_ridge.csv has been created!")
