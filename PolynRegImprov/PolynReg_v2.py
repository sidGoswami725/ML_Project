...
# --- Tuning: Ridge Alpha (increased search space for Alpha)
# --- Preprocessing: User-provided (modified for Pipeline)
# ==============================================================================

# The score got worse from 27859.841 to 28532.162
# It proves that PolynomialFeatures(degree=2) adds too much noise and complexity 
# for any linear model, even a heavily regularized one like Ridge, 
# to handle effectively on this dataset.
...
submission_df.to_csv("submission_polyv2.csv", index=False)

print("\n" + "=" * 80)
print("submission_polyv2.csv has been created!")
