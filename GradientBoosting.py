...
print("Starting Gradient Boosting script...")
...
# Note: Scaling is less critical for Gradient Boosting, but still good practice
...
print("\n" + "=" * 80)
print("submission_gb.csv has been created!")
