...
# The kaggle score got worse (18505.117)
# We learnt that alpha above 10 is giving worse scores. So let's restrict the 
# search space below 10
...
# We now know the best score is at alpha=10. Let's check around it.
param_grid = {
...
submission_df.to_csv("submission_ridgev2.csv", index=False)

print("\n" + "=" * 80)
print("submission_ridgev2.csv has been created!")
