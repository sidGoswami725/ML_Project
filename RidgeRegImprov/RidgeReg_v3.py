...
# Kaggle score improved (18345.818)
# We learnt that alpha below 10 seems to be giving very good results. Let's do an
# aggressive experiment with alpha <= 5 next.
...
# We now know the best score is at alpha=10. Let's check below it.
param_grid = {
...
submission_df.to_csv("submission_ridgev3.csv", index=False)

print("\n" + "=" * 80)
print("submission_ridgev3.csv has been created!")
