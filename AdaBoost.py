...
print("Starting AdaBoost script...")
...
submission_df.to_csv("submission_ada.csv", index=False)

print("\n" + "=" * 80)
print("submission_ada.csv has been created!")
