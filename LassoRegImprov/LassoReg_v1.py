...
# Using Manual loop to find best alpha values instead of GridSearchCV (Same Function)
# Score improved from 19845.634 to 19147.346
# Let's try zooming in on alpha values for Lasso as well and see if performance
# improves or not (in the next version).
...
best_lasso_alpha = 0
# Using the exact alpha list from your friend
...
submission_df.to_csv("submission_lassov1.csv", index=False)

print("\n" + "=" * 80)
print("submission_lassov1.csv has been created!")
