...
param_grid = {"alpha": [0.0001, 0.0003, 0.0005, 0.0007, 0.001]}

print("Tuning Lasso Regression (searching for best alpha)...")
...
print("\n" + "=" * 80)
print("submission_lasso.csv has been created!")
